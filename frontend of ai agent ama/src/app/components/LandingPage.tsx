...
import {
  ...
  Star, Menu, X, Sparkles, ChevronRight, Download
} from 'lucide-react';
...
function MobileLandingPage({ installPrompt, onInstall }: MobileLandingPageProps) {
      ...
      <nav className="relative z-20 flex items-center justify-between px-5 py-4 bg-[#030014]/80 backdrop-blur-xl border-b border-white/5 sticky top-0">
        ...
        <div className="flex items-center gap-2">
          {installPrompt && (
            <button
              onClick={onInstall}
              className="px-2.5 py-1.5 text-[11px] font-bold text-amber-400 bg-amber-500/10 border border-amber-500/30 rounded-lg hover:bg-amber-500/20 transition-all flex items-center gap-1 shadow-sm"
            >
  ...
  return (
    <>
      ...
      <div className="md:hidden">
        <MobileLandingPage installPrompt={installPrompt} onInstall={handleInstall} />
      </div>
              ...
              <div className="hidden md:flex items-center gap-3">
                {installPrompt && (
                  <button
                    ...
                    className="px-4 py-2 text-sm font-semibold text-amber-400 bg-amber-500/10 border border-amber-500/30 rounded-xl hover:bg-amber-500/20 transition-all flex items-center gap-2 shadow-sm shadow-amber-500/10"
                  >
